...
VALUES ('John1', 'Doe', '2002-10-10', '1234 654321', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'john.doe@example.com')),
       ('John2', 'Doe', '2003-10-11', '1234 654321', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'john.doe@example.com')),
       ('John3', 'Doe', '2004-10-12', '1234 654321', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'john.doe@example.com')),
       ('Jane1', 'Smith', '2002-10-13', '1234 654322', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'jane.smith@example.com')),
       ('Jane2', 'Smith', '2003-10-14', '1234 654322', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'jane.smith@example.com')),
       ('Jane3', 'Smith', '2004-10-15', '1234 654322', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'jane.smith@example.com')),
       ('Michael1', 'Johnson', '2002-10-16', '1234 654323', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'michael.johnson@example.com')),
       ('Michael2', 'Johnson', '2003-10-17', '1234 654323', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'michael.johnson@example.com')),
       ('Michael3', 'Johnson', '2004-10-18', '1234 654323', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'michael.johnson@example.com')),
       ('Emily1', 'Brown', '2002-10-19', '1234 654324', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'emily.brown@example.com')),
       ('Emily2', 'Brown', '2003-10-20', '1234 654324', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'emily.brown@example.com')),
       ('Emily3', 'Brown', '2004-10-21', '1234 654324', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'emily.brown@example.com')),
       ('David1', 'Miller', '2002-10-22', '1234 654325', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'david.miller@example.com'));
       ('David2', 'Miller', '2003-10-23', '1234 654325', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'david.miller@example.com'));
       ('David3', 'Miller', '2004-10-23', '1234 654325', '2018-10-19', 'Passport', (SELECT id FROM account_passenger WHERE email = 'david.miller@example.com'));
